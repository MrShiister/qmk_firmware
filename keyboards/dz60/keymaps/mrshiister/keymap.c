...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    LAYOUT_60_ansi(
	    ...
	    LT(2, KC_CAPS), KC_A,	KC_O,		KC_E,		KC_U,		KC_I,		KC_D,		KC_H,		KC_T,		KC_N,		KC_S,		KC_MINS,		KC_ENT,
	    KC_LSFT,	KC_SCLN,	KC_Q,		KC_J,		KC_K,		KC_X,		KC_B,		KC_M,		KC_W,		KC_V,		KC_Z,			        RSFT_T(KC_DEL),
	    OS_LCTL,	OS_LGUI,	OS_LALT,					KC_SPC,								KC_LEFT,	KC_DOWN,	KC_UP,		KC_RGHT
    ),
    ...
    LAYOUT_60_ansi(
        ...
        KC_TRNS,    OS_TOGG,    PB_2,       PB_3,       PB_4,       PB_5,       PB_6,       KC_P4,      KC_P5,      KC_P6,     DF(1),      DF(0),        KC_TRNS,
        KC_TRNS,    KC_PWR,     KC_SLEP,    KC_COPY,    KC_PSTE,    KC_TRNS,    KC_TRNS,    KC_P1,      KC_P2,      KC_P3,         KC_PDOT,           KC_TRNS,
        KC_HOME,    QK_LAYER_LOCK, KC_END,                  KC_P0,                              KC_NUM,     KC_RALT,    NK_TOGG,    KC_RCTL
    ),
