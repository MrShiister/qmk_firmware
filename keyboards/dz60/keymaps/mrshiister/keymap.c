...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	TT(_RGB),	KC_VOLD,	KC_VOLU,	KC_MPLY,	KC_MSTP,	KC_MPRV,	KC_MNXT,	KC_P7,		KC_P8,		KC_P9,		KC_INS,		KC_PGUP,	KC_PGDN,	KC_PSCR,		
	KC_TRNS,	KC_CAPS,	KC_CALC,	KC_BTN1,	KC_BTN2,	KC_UP,		KC_PAUS,	KC_P4,		KC_P5,		KC_P6,		DF(_BL),	DF(_DVORAK),	KC_TRNS,		
	KC_TRNS,	KC_PWR,		KC_SLEP,	KC_HAEN,	KC_LEFT,	KC_DOWN,	KC_RGHT,	KC_P1,		KC_P2,		KC_P3,		KC_COPY,			KC_PSTE,		
	KC_HOME,	KC_MUTE,	KC_END,						KC_P0,								KC_PDOT,	KC_NLCK,	MAGIC_HOST_NKRO,MAGIC_UNHOST_NKRO),		
	...
	*/
	...
	KC_TRNS,	BL_TOGG,	BL_STEP,	BL_ON,		BL_OFF,		BL_INC,		BL_DEC,		BL_BRTG,	KC_NO,		KC_NO,		KC_NO,		DEBUG,		RESET,		KC_NO,		
	KC_NO,		RGB_TOG,	RGB_MOD,	RGB_RMOD,	RGB_HUI,	RGB_HUD,	RGB_SAI,	RGB_SAD,	RGB_VAI,	RGB_VAD,	RGB_SPI,	RGB_SPD,		SAVE_RGB,		
	...
	TT(_FN),	KC_A,		KC_O,		KC_E,		KC_U,		KC_I,		KC_D,		KC_H,		KC_T,		KC_N,		KC_S,		KC_MINS,		KC_ENT,		
