...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    LAYOUT_65_ansi_blocker(
        ...
        OS_LCTL,    OS_LGUI,    OS_LALT,                            KC_SPC,                             KC_RALT,        KC_RCTL,                    KC_LEFT,        KC_DOWN,    KC_RGHT
    ),
    ...
    LAYOUT_65_ansi_blocker(
        ...
        KC_TRNS,    OS_TOGG,    PB_2,       PB_3,       PB_4,       PB_5,       PB_6,       KC_P4,      KC_P5,      KC_P6,      DF(1),      DF(0),              KC_TRNS,        KC_TRNS,
        KC_TRNS,    KC_PWR,     KC_SLEP,    KC_COPY,    KC_PSTE,    KC_TRNS,    KC_TRNS,    KC_P1,      KC_P2,      KC_P3,      KC_PDOT,        KC_TRNS,            KC_TRNS,    KC_TRNS,
        KC_HOME,    QK_LAYER_LOCK, KC_END,                          KC_P0,                              KC_NUM,         KC_RALT,                    NK_TOGG,        KC_RCTL,    KC_TRNS
    ),
    ...
    LAYOUT_65_ansi_blocker(
        ...
        KC_NO,      QK_LAYER_LOCK, KC_NO,                           KC_NO,                              KC_NO,          KC_NO,                      KC_NO,          KC_NO,      KC_TRNS
    )
    /* clang-format on */
};
...
layer_state_t layer_state_set_user(layer_state_t state) {
    switch (biton32(state)) {
        ...
        case 3:
            rgblight_mode_noeeprom(1);
            // Set to red
            rgblight_sethsv_noeeprom(128, 255, 63);
            break;
